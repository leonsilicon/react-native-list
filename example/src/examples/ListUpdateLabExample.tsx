...
import { DebugButton, ExampleHeader } from "../components";
import { ROW_WIDTH, styles } from "../styles";
...
export function ListUpdateLabExample(props: { onBack: () => void }) {
  ...
  return (
    <View style={styles.root}>
      <ExampleHeader
        ...
        subtitle="Exercise inserts, reloads, moves, and height updates."
        onBack={props.onBack}
      />
