...
- (instancetype) init {
  if (self = [super init]) {
    std::shared_ptr<HybridUiListViewSpec> hybridView = NitroList::NitroListAutolinking::UiListView::create();
...
+ (BOOL)shouldBeRecycled {
  return NitroList::NitroListAutolinking::UiListView::isRecyclableHybridView();
}
